...
export const BreedingList = ({ navigation }) => {
  ...
  useEffect(() => {
    axios
      .get("https://petzone99.herokuapp.com/api/v1/offerBreeding")
      .then((res) => {
  ...
  function filterTypeDog() {
    ...
    axios
      ...
      .then((res) => {
        Setdatainfo(res.data.breedingOffer);
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  function Apply() {
    ...
    var string3 = url2 + string + string1 + string2;
    axios
      .get("https://petzone99.herokuapp.com/api/v1/offerBreeding" + string3, {
