...
export const Hotelsmap = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        setdatainfo1(res.data.hotels);
        console.log("all", datainfo);
      })
      .catch((err) => {
            ...
            return (
              <Card
                ...
                onPress={() => {
                  ...
                  temp_element.latitude = parseFloat(item.latitude);
                  temp_element.longitude = parseFloat(item.longitude);
